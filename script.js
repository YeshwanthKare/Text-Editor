...
makeUnderline = (elem) => {
    ...
    console.log(elem);
    elem.classList.toggle("active");
    let x = document.getElementById("text-output").classList
    x.contains('underline') ? x.remove("underline") : x.add("underline");
}
...
alignText = (elem, alignType) => {
  // CODE GOES HERE
  console.log(elem, alignType);
  elem.classList.toggle("active");
  document.getElementById("text-output").style.textAlign = alignType;
  let buttonsList = document.getElementsByClassName('align');
  for(let elem of buttonsList){
